...
func (fs *fuseInterface) Opendir(path string) (int, uint64) {
...
func (fs *fuseInterface) Releasedir(path string, fh uint64) int {
...
func (fs *fuseInterface) Readdir(path string,
